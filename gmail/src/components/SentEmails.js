// src/components/SentEmails.js
import React, { useEffect, useState } from 'react';
import axios from 'axios';
import './MainContent.css'; // Ensure you have styling for this component
...
const SentEmails = () => {
    ...
    useEffect(() => {
        const fetchSentEmails = async () => {
            ...
            const userEmail = user.user.emailId; // Get logged-in user's email
